""" User account database model (username, email, password) """
...
class User(UserMixin, db.Model):
    ...
    # query followed to check if the users follow each other
    ...
    # create follower posts feed including users own posts
